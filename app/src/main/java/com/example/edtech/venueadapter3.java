...
public class venueadapter3 extends RecyclerView.Adapter<venueadapter3.MyViewHolder> {
    ...
    public venueadapter3(Context context, ArrayList<String> city, ArrayList<String> seat, ArrayList<String> ground_name,ArrayList<String> home_ground,ArrayList<String> start,ArrayList<String> end,ArrayList<Integer> mentorImage) {
